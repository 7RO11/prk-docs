...
export default function BioAnalyzingTargetingGoggles() {
  return (
    <Trifold>
      <Sitenav />
      <Navbar />
      <Centerpiece>
        <Nobottom>
          ...
          <Mainheader>Bio-Analyzing Targeting Goggles</Mainheader>
        </Nobottom>
        <Mainrule />
        <div>
          ...
          <Itembox
            itemOne={"Bio-Analyzing Targeting Goggles"}
            itemOnePic={"/goggles/bioanalyzingtargetinggoggles.png"}
          />
          <Softrule />
